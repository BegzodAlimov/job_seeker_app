...
const SupportContact = () => {
  return (
    <div className="rounded-3xl bg-white p-8 font-font-family tracking-[0.01em] max-h-[430px]">
        <h2 className="font-medium text-5xl text-[#09080d] mb-3">Support</h2>
        <p className="text-[16px] font-normal text-[#7d7c84] max-w-[355px] mb-10">
          Fill up the form and our team will get back to you with in 24 hours.
        </p>
        <ul className="font-medium text-[#09080d] flex gap-y-10 flex-col">
          <li className="flex items-center gap-x-3">
            <div className="border rounded-3xl border-[#bdc7f4] p-3 flex items-center justify-center w-max">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
