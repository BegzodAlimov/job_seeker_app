...
const Banner = () => {
  return (
      <div className='flex md:gap-8 max-md:flex-col-reverse'>
          <div className='md:w-1/2 bg-card md:rounded-3xl rounded-2xl bg-primary-10 text-white xs:px-10 xs:py-8 p-5 flex  flex-col sm:gap-5 gap-3 max-md:-translate-y-6 z-10'>
              ...
              <Button variant='ghost' size={'lg'} className='rounded-full border border-white bg-white text-primary-10 text-base font-semibold hover:text-white hover:bg-primary-10 w-fit py-7'>Get Started</Button>
